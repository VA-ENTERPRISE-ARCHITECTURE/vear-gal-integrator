...
public class ADRecordsWriter {
    ...
    private static final Logger LOG = Logger.getLogger(ADRecordsWriter.class.getName());
	...
	while (outIterator.hasNext()) {
		...
		row.createCell(3).setCellValue(outRecord.getVaUserName());
		row.createCell(4).setCellValue(outRecord.getDistinguishedName());
